...
@rem              (@DOCSHOST/platforms/index.html) for an up-to-date list of 
...
goto checkJava
@rem @echo.
@rem @echo The WebLogic Server wasn't found in directory %WL_HOME%\server.
@rem @echo Please edit the setant.cmd script so that the WL_HOME
@rem @echo variable points to the WebLogic installation directory.
@rem @echo Your environment has not been set.
@rem @goto finish
...
@rem @echo Please edit the setWLSEnv.cmd script so that the JAVA_HOME
@rem @echo variable points to the location of your JDK.
